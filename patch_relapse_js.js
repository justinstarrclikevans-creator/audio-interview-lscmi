...
const targetStr = \`<button class="btn btn-primary" style="padding: 2px 4px; font-size: 9px; margin-top: 4px; display: block; width: 100%;" onclick="openGateChecklistModal(\${p.id}, '\${escName}')">✅ Gate Checklist</button>\`;
...
if (appJs.includes(targetStr) && !appJs.includes("Sub. Relapse Plan")) {
    appJs = appJs.replace(targetStr, targetStr + appendStr);
    console.log("✅ Added buttons to caseload");
}
